...
function closeSubmenu() {
    try {
        ...
        console.error('Error al cerrar el submenú:', error);
    }
}
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    ${item.subitems && item.subitems.length > 0 ? `
                                                        <button class="btn btn-link p-0" data-toggle="collapse" data-target="#collapse-${section.section}-${itemIndex}" aria-expanded="false" aria-controls="collapse-${section.section}-${itemIndex}">
                                                            <i class="fas fa-chevron-down"></i>
                                                        </button>
                                                    ` : ''}
                                                </div>
                                                ${item.subitems && item.subitems.length > 0 ? `
                                                    <div id="collapse-${section.section}-${itemIndex}" class="collapse" data-parent="#accordion-${section.section}">
